...
export const pageMeta = {
  services: ['サービス概要・支援内容', '支援範囲を、対象者と項目からすばやく確認できます。'],
  timeline: ['着任時期から逆算する', '4月・9月着任に合わせて、準備の目安を確認できます。'],
  accommodation: ['宿泊候補', 'エリア・アクセス・滞在期間で候補を比較できます。'],
  fees: ['費用の考え方', '固定料金表ではなく、案件ごとに費用区分を整理します。'],
  faq: ['よくある質問', '相談前によく確認されるポイントを短くまとめました。'],
  visitors: ['For International Visitors', 'Start here for arrival, accommodation, and first-day support.'],
  contact: ['お問い合わせ', '分かる範囲の情報から、気軽に初期相談へ進めます。'],
} as const;

export const pageHeroDetails = {
  services: { label: 'Support overview', chips: ['対象者別', '支援項目', '連携先'], cta: '支援内容を見る' },
  timeline: { label: 'Preparation guide', chips: ['4月着任', '9月着任', '早めの相談'], cta: '時期を確認' },
  accommodation: { label: 'Compare options', chips: ['エリア', 'アクセス', '滞在期間'], cta: '候補を比較' },
  fees: { label: 'Quotation based', chips: ['個別見積', '基本支援', '実費'], cta: '費用区分を見る' },
  faq: { label: 'Quick answers', chips: ['相談前', 'よくある質問', '確認ポイント'], cta: 'FAQを見る' },
  visitors: { label: 'Visitor guide', chips: ['Host office first', 'Before arrival', 'Campus support'], cta: 'Guideを確認' },
  contact: { label: 'First consultation', chips: ['分かる範囲でOK', '初期相談', '後日連携'], cta: '入力へ進む' },
} as const;
